...
void replace_words_in_file(char *file_name, char *lyb_name, char *first_word, char *second_word);
int check_in_lyb(char *lyb_name, char *word);
...
void replace_words_in_file(char *file_name, char *lyb_name, char *first_word, char *second_word) {
    ...
    if (fopen_s(&compressed_file, "compressed_file.txt", "rt+") != 0) {
    ...
    while(fscanf(f, "%s", word_tmp) == 1) {
        ...
        if (strcmp(first_word, cleaned_word) == 0) {
            ...
            fputs(" ", compressed_file);
        } else if(check_in_lyb(lyb_name, cleaned_word) == 0){
